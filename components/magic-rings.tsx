...
type LiveProps = Required<Omit<MagicRingsProps, "blur" | "className">>
...
export default function MagicRings({
  ...
  // O loop lê as props mais recentes por ref, sem recriar o renderer a cada render
  useLayoutEffect(() => {
    propsRef.current = {
      color,
      colorTwo,
  ...
  useEffect(() => {
    ...
    // Só renderiza com o elemento na tela e a aba visível
    const tryStart = () => {
